...
import com.server.chirp.service.impl.DynamoDBChirpService;
import com.server.chirp.service.impl.DynamoDBUserService;
...
public class App {
	public static void main(String[] args) {
		...
		new UserController(new DynamoDBUserService(new DynamoDBUserStorage()));
		new ChirpController(new DynamoDBChirpService(new DynamoDBChirpStorage()));
	}
}
